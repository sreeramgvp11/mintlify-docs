...
| [`/connectors/:id/resources`](/api-reference/v2/endpoint/connector-resources) | `POST` | Add an individual resource row |
| [`/connectors/:id/resources/:resource_id`](/api-reference/v2/endpoint/connector-resources) | `DELETE` | Remove a resource |
