...
```json
{
  "tenant_metadata_schema": [
    {"name": "compliance_framework", "data_type": "string", "enable_match": true, "enable_dense_embedding": true},
    {"name": "data_classification", "data_type": "string", "enable_match": true},
    {"name": "region", "data_type": "string", "enable_match": true}
  ]
}
```
