...
> **Note:** This API performs full text search with configurable operators for precise text matching. For retrieval-backed answers, use `POST /recall/full_recall` and generate the final response in your application layer.
